...
You can find the script at `share/systemtap/demo.stp`, or reproduced below:
...
You can run the script to trace `bitcoind` in regtest mode using the following
command:

```bash
# Use stap to trace bitcoind in regtest mode.
$ stap -I ./share/systemtap/tapset \
       -c "./src/bitcoind -regtest" \
       ./share/systemtap/demo.stp
...
$ ./src/bitcoin-cli -regtest generate 5
[
...
very incomplete, and doesn't properly rename arguments.

The following example shows how to list the probes provided by the tapset:

```bash
$ stap -I share/systemtap/tapset -L 'bitcoin.*'
bitcoin.cache_flush name:string coins:long bytes:long $arg1:long $arg2:long
bitcoin.cache_hit name:string
bitcoin.cache_miss name:string
bitcoin.finish_ibd name:string
bitcoin.init_main name:string datadir:string configpath:string $arg1:long $arg2:long
bitcoin.read_block_from_disk name:string height:long filenum:long $arg1:long $arg2:long
bitcoin.update_tip name:string block_hash:string height:long cache_size:long cache_bytes:long progress:long $arg1:long $arg2:long $arg3:long $arg4:long $arg5:long
```
